let produtosNoCarrinho = new Array();
...
if(localStorage.getItem("produtosNoCarrinho") != null){
 ...
 {
    carregaProdutosNoLayout(produtosNoCarrinho)
    carregaResumoNoLayout(produtosNoCarrinho)
 }
...
function configuraLixeira(index){
    ...
    element.onclick = function(){
        ...
        (produtosNoCarrinho).splice(child.id,1)
